    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Inventory>(entity =>
        {
            entity.ToTable("Inventory", tb =>
                {
                    tb.HasTrigger("MSmerge_del_16A16C150E134B669A814362F7667E7A");
                    tb.HasTrigger("MSmerge_ins_16A16C150E134B669A814362F7667E7A");
                    tb.HasTrigger("MSmerge_upd_16A16C150E134B669A814362F7667E7A");
                });
        ...
        modelBuilder.Entity<Order>(entity =>
        {
            entity.ToTable(tb =>
                {
                    tb.HasTrigger("MSmerge_del_C5FD9FD4BEE94315954BF7E47C18FB89");
                    tb.HasTrigger("MSmerge_ins_C5FD9FD4BEE94315954BF7E47C18FB89");
                    tb.HasTrigger("MSmerge_upd_C5FD9FD4BEE94315954BF7E47C18FB89");
                });
        ...
        modelBuilder.Entity<OrderItem>(entity =>
        {
            ...
            entity.ToTable(tb =>
                {
                    tb.HasTrigger("MSmerge_del_DE669EC3DC434054B477E048D8DCB395");
                    tb.HasTrigger("MSmerge_ins_DE669EC3DC434054B477E048D8DCB395");
                    tb.HasTrigger("MSmerge_upd_DE669EC3DC434054B477E048D8DCB395");
                });
        ...
        modelBuilder.Entity<ProductMovement>(entity =>
        {
            ...
            entity.ToTable("ProductMovement", tb =>
                {
                    tb.HasTrigger("MSmerge_del_D3D64D1F9998467FBA5BD0FC6F8757E8");
                    tb.HasTrigger("MSmerge_ins_D3D64D1F9998467FBA5BD0FC6F8757E8");
                    tb.HasTrigger("MSmerge_upd_D3D64D1F9998467FBA5BD0FC6F8757E8");
                });
            ...
            entity.Property(e => e.DraftDate)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime");
            entity.Property(e => e.MovementStatusID).HasDefaultValue(1);
            entity.Property(e => e.Quantity).HasColumnType("decimal(10, 2)");
            entity.Property(e => e.SubmitDate)
                .HasDefaultValue(new DateTime(1900, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified))
                .HasColumnType("datetime");
        ...
        modelBuilder.Entity<ProductMovementItem>(entity =>
        {
            ...
            entity.ToTable(tb =>
                {
                    tb.HasTrigger("MSmerge_del_6C2FFA5E08394C249B89B2BB928E60E2");
                    tb.HasTrigger("MSmerge_ins_6C2FFA5E08394C249B89B2BB928E60E2");
                    tb.HasTrigger("MSmerge_upd_6C2FFA5E08394C249B89B2BB928E60E2");
                });
        ...
        {
            entity.HasKey(e => new { e.Prod_Num, e.Store_ID });
